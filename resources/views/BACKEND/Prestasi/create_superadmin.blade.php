...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <h1>Tambah Prestasi (Superadmin)</h1>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('prestasi.superadmin.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <select name="admin_ekstra_id" class="form-control" required>
                                ...
                                @foreach ($pengelola as $item)
                                    <option value="{{ $item->id }}" {{ old('admin_ekstra_id') == $item->id ? 'selected' : '' }}>
